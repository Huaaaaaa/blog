...
<script type="text/javascript" src="${pageContext.request.contextPath}/modules/blog/js/blog_right_nopage.js"></script>
...
<body>
	<div class="blog_btn">
		<button id="blog_page" type="button" class="btn btn-info btn-lg">
			<span class="glyphicon">分页列表</span>
		</button>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="" enctype="multipart/form-data" id="upload_file_form">
						<span style="display: inline; margin-left: 50px;">请选择上传文件:</span><input
							id="file1" type="file" name="up_blog" style="display: inline;">
						<div id="filecheck" class="alert alert-danger">
							<strong>Warning!</strong>只能上传pdf和word两种类型的文件
						</div>
					</form>
