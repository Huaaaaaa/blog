...
$(function(){
	...
	//初始化表格
	var table = $("#blog_table_nopage").dataTable({
		language:lang,  //提示信息
		...
		ajax: function (data, callback, settings) {
			...
			$.ajax({
				type: "GET",
				url: "/blog/getBlogList?isPage=yes",
				cache: false,  //禁用缓存
				data: param,  //传入组装的参数
				dataType: "json",
	...
	$("#blog_nopage").click(function(){
		location.href="/blog/right?isPage=no";
	});
	//创建日志
