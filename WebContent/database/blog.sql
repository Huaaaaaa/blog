...
-- Records of blog
-- ----------------------------
INSERT INTO `blog` VALUES ('1', '放大放大放大', '<div style=\"text-align: center;\"><span style=\"line-height: 1.42857143;\">放大放大放大师傅的</span></div><div style=\"text-align: left;\"><ul><li>打发阿凡达大</li><li>回宿舍收到货</li><li>我要我要我要听五月天</li></ul></div>', 'admin', '2017-01-3 14:16:31', '放大放大撒', '1', '1', null, null, null, '放大放大放大师傅的打发阿凡达大回宿舍收到货我要我要我要听五月天');
...
INSERT INTO `blog` VALUES ('8', '放水电费', '放大声地', 'admin', '2017-01-3 16:7:2', '官方对双方都', null, null, null, null, null, '放大声地');
INSERT INTO `blog` VALUES ('9', '各方施工方', '<div style=\"text-align: center;\"><span style=\"line-height: 1.42857143;\">各方施工方手动各方施工方手动</span></div><div style=\"text-align: center;\"><ul><li style=\"text-align: left;\">官方烦烦烦烦烦烦烦烦烦烦烦</li></ul></div>', 'admin', '2017-01-3 16:8:17', '各方施工方手动', null, null, null, null, null, '各方施工方手动各方施工方手动官方烦烦烦烦烦烦烦烦烦烦烦');
INSERT INTO `blog` VALUES ('10', '放大放大撒', '放大放大撒', 'admin', '2017-01-3 16:9:52', '发大水发大水', '1', '1', null, null, null, '放大放大撒');
INSERT INTO `blog` VALUES ('11', '一万公里的约定', '<div style=\"text-align: center;\"><span style=\"line-height: 1.42857143;\">一万公里的约定</span></div><div style=\"text-align: left;\"><ol><li>主演</li><li>剧情</li><li>导演</li><li>监制</li></ol></div>', 'admin', '2017-01-9 10:51:22', '地方放大幅度', '1', '1', null, null, null, '一万公里的约定主演剧情导演监制');
...
CREATE TABLE `blog_user` (
  ...
  `figure` varchar(255) DEFAULT NULL COMMENT '头像',
  ...
  `access_authority` varchar(50) DEFAULT NULL COMMENT '访问权限',
  `is_show` varchar(10) DEFAULT NULL COMMENT '是否显示在首页',
...
-- ----------------------------
INSERT INTO `blog_user` VALUES ('1', 'admin', 'admin', 'admin', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
