...
(function($, window) {
  ...
  // creation/appManagement of `Sammy.Application` instances. There are a
  ...
  */
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    {
	if(!this._pathTable)
	  this._pathTable=new HashMap();
	return this._pathTable.containsKey(path);
    },
